...
import com.test.json.JSONtoLowerTools;
...
import com.test.tcb.vo.TcbComfirmDriverFee;
import com.test.tcb.vo.TcbComfirmDriverFeeVO;
import com.test.tcb.vo.TcbDriver;
import com.test.tcb.vo.TcbPayoutFee;
import com.test.tcb.vo.TcbSyncFee;
...
//		{"accreditid":"tcbzcdtest","appkey":"D2EE3201ACAD261606B8DC9DD1761209FE15D467B49E39AFF0FC430BA2AFA632","businessid":"Y15120022-1-1","cmd":"SaveFee","data":[{"amount":30,"feeid":1407,"ispicture":1,"synctime":"2015-12-04 18:42:33"}],"transmitaccreditid":"tcbtest"}
		...
		if (JsonHelper.getJSONType(rvalue) == JsonHelper.FS_JSON_TYPE_OBJECT) {
			JSONObject object=JSONObject.fromObject(rvalue);
			JsonMsg jsonMsg=new JsonMsg();
			jsonMsg.setRet(object.getInt("ret"));
			jsonMsg.setMsg(object.getString("msg"));
			jsonMsg.setData(object.getString("data"));
			System.out.println(jsonMsg.getData());
			JSONObject o = JSONtoLowerTools.transObject(object);
